<td style="vertical-align: middle">
    <input type="text" class="form-control txtFieldName" required placeholder="Enter model name" >
    <input type="text" class="form-control foreignTable txtForeignTable" style="display: none" placeholder="Foreign table,Primary key"/>
</td>
<td style="vertical-align: middle">
    <div class="form-group" data-select2-id="dbTypeSelect">
        <select class="form-control select2 select2-hidden-accessible txtdbType" data-select2-id="dbType-select2" tabindex="-1" aria-hidden="true">
...
<td style="vertical-align: middle">
    <select class="form-control select2 select2-hidden-accessible drdHtmlType">
        <option value="text">Text</option>
